...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <div class="container">
            <a class="navbar-brand" href="relatorio.php">VPRO | estoque</a>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    */
                    if (isset($_SESSION['user']) && !empty($_SESSION['user'])) { ?>
                        <li class="nav-item">
                            <a class="nav-link" target="_blank" href="index.php">Página inicial</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" target="_blank" href="relatorio.php">Relatórios</a>
                        </li>
                        <form method="POST">
                ...
                <thead>
                    ...
                    <?php
                       ...
                       <tr>
                            ...
                            <?php 
                            /* 
                            here we will check if item is available
                            if it is, we display button to register donation
                            */
                            if ($estoque['Qtd'] != 0) { ?>
                                <button type="submit" name="registrarSaida" class="btn btn-outline-primary aprovar">Registrar</button>
                            <?php } else {
                                echo "-";
                            }                                
                            ?>
    ...
    <!-- Footer -->
    <footer class="py-5 bg-black" style="margin-top: 14%;">
        <div class="container">
